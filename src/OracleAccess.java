...
//	private String pwd = "issinatour90";
 ...
 // recoge las sentencias sql, las ejecuta y devuelve el resultado en  temp
	...
	//recibe nombrte tabla y devuelve linkedlist con los nombres de todas las columnas
	public LinkedList <String> consultaNombreColumnas(String tabla) throws SQLException {
		LinkedList<String> nombresColumnas = new LinkedList <String>();
